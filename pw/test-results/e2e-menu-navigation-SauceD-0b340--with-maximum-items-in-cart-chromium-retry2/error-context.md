...
- Name: e2e\menu-navigation.spec.ts >> SauceDemo Menu & Navigation Tests >> Error Handling & Edge Cases >> Menu with maximum items in cart
- Location: tests\e2e\menu-navigation.spec.ts:502:9
