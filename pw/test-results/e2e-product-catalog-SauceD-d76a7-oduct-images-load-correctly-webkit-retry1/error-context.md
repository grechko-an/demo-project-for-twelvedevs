...
- Name: e2e\product-catalog.spec.ts >> SauceDemo Product Catalog & Sorting Tests >> Additional Catalog Tests >> Verify product images load correctly
- Location: tests\e2e\product-catalog.spec.ts:173:9
