...
- Name: e2e\menu-navigation.spec.ts >> SauceDemo Menu & Navigation Tests >> Reset App State Detailed Tests >> Reset app state multiple times
- Location: tests\e2e\menu-navigation.spec.ts:298:9
