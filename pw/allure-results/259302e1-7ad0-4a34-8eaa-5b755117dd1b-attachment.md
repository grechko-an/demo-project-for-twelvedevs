...
- Name: e2e\menu-navigation.spec.ts >> SauceDemo Menu & Navigation Tests >> Reset App State Detailed Tests >> Reset app state preserves login session
- Location: tests\e2e\menu-navigation.spec.ts:278:9
