...
- Name: e2e\product-catalog.spec.ts >> SauceDemo Product Catalog & Sorting Tests >> Additional Catalog Tests >> Sorting persistence after page refresh
- Location: tests\e2e\product-catalog.spec.ts:203:9
